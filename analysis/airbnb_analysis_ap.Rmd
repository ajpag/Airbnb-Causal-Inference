...
book$first_device_type <- as.factor(book$gender)
book$browser_group <- as.factor(book$browser_group)
book$is_direct <- as.factor(book$is_direct)
```
...
gbart(x.train = as.data.frame(book_sample %>% 
                                select(age, gender, first_device_type, 
                                       browser_group, is_direct)), 
      y.train = book_sample$is_direct,
      type = "lbart")
```
