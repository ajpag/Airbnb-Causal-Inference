...
```{r desc_stats, eval = FALSE, include=FALSE}
# descriptive statistics
# output used for PPT only
# only renders in HTML
table1::label(dat$age) <- "Age"
table1::label(dat$browser_group) <- "Browser Group"
<<<<<<< HEAD
table1::label(dat$gender) <- "Gender"
table1::label(dat$is_eng) <- "Language (1 = English, 0 = Other)"
table1::label(dat$first_device_type) <- "Device"

table1::table1(~age + browser_group + gender + 
                is_eng + first_device_type, data = dat)
=======
table1::label(dat$is_eng) <- "Language (1 = English, 0 = Other)"
table1::label(dat$first_device_type) <- "Device"

table1::table1(~age + browser_group + is_eng + first_device_type, data = dat)
>>>>>>> 70f639ea480d7b67ee3262868fbd3320fa125824
```
...
The best model based on the lowest average balance metric and closest 
sd ratio to 1 is BART IPTW.
